...
const routes: Routes = [
  ...
  {
    path: 'alta-producto',
    loadChildren: () => import('./paginas/producto/alta-producto/alta-producto.module').then(m => m.AltaProductoPageModule)
  },  {
    path: 'alta-reserva',
    loadChildren: () => import('./paginas/reservas/alta-reserva/alta-reserva.module').then( m => m.AltaReservaPageModule)
  }
